...
namespace KiarcheContinuumWar.InputSystem
{
    ...
    ""maps"": [
        {
            ""name"": ""RTS"",
            ""id"": ""0b2e0e94-8a5c-4f3a-9c1e-2d3e4f5a6b7c"",
            ""actions"": [
                {
                    ""name"": ""Left Click"",
                    ""type"": ""Button"",
    ...
    ""controlSchemes"": []
            ...
            m_RTS_MousePosition = m_RTS.FindAction("Mouse Position", throwIfNotFound: true);
        }

        ~@PlayerInput()
        {
            UnityEngine.Debug.Assert(!m_RTS.enabled, "This will cause a leak and performance issues, PlayerInput.RTS.Disable() has not been called.");
        }
