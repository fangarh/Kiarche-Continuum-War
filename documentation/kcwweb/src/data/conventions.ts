  ...
  categories: [
...

    {
      ...
      items: [
        ...
        {
          id: 'mech-002',
          title: 'Играбельные фракционные блоки',
          status: 'active',
          description: 'Молодые расы образуют основной набор асимметричных RTS-фракций, а Тал\'Син существуют как отдельная RTS-фракция с механикой идентичности.',
        },
        {
          id: 'mech-003',
