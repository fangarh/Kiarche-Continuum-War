...
//
// =============================================================================
// ВАЖНО: Приоритет разработки рас
// =============================================================================
//
// ИГРАБЕЛЬНЫЕ РАСЫ (в разработке):
// - Тал'Син — уникальная механика идентичности и синхронизации
// - Молодые расы — классическая 4X-кампания (Фракции 1, 2, 3)
//
// НЕИГРАБЕЛЬНЫЕ РАСЫ (отложено до Post-Release/DLC):
// - Синтекс — создатели Portal Network, конфликт с Ки'Архе
// - Ки'Архе — распределённое поле, «боги» за сценой (не прямое управление)
// - Этерны — вознесённая раса
// - Кешари — гуманоидная раса, нейтралитет
// - Сил'Ни — пацифистская раса
// - Вел'Кеты — паразитическая раса
//
// Неиграбельные расы будут проработаны позже для:
// - Сюжетных миссий
// - Антагонистов
// - Будущих DLC (новые фракции)
// ----------------------------------------------------------------------------
      ...
      milestones: [
        {
          ...
          endDate: '2027-10-31',
          tasks: [
            { id: 'task-037', title: 'Фракция 1 (Молодые расы) — описание, юниты, герои', completed: false },
            { id: 'task-038', title: 'Фракция 2 (Молодые расы) — описание, юниты, герои', completed: false },
            { id: 'task-039', title: 'Фракция 3 (Молодые расы) — описание, юниты, герои', completed: false },
            { id: 'task-040', title: 'Тал\'Син — детальная механика синхронизации и развития', completed: false },
            { id: 'task-041', title: 'Сюжетные миссии — 3 акта кампании (молодые расы)', completed: false },
            ...
            { id: 'task-044', title: 'Механика "Последний козырь" — вмешательство Ки\'Архе', completed: false },
          ],
        },
        {
